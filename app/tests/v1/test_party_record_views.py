...
class TestParty(unittest.TestCase):
    ...
    def test_valid_inputs(self):
        response = self.party(party_name='jubilee',party_headquarters_address = "jos@gmail.com",party_logo = (BytesIO(b'my file contents'), "test.jpg"))
    ...
    #     response = self.put_party(party_name='jubilee',party_headquarters_address = "jos@gmail.com",party_logo = (BytesIO(b'my file contents'), "test.jpg"))
    #     self.assertEqual(response.status_code,201)
    def test_put_taken_party_name(self):
        response = self.put_party(party_name='taken_party',party_headquarters_address = "jos@gmail.com",party_logo =(BytesIO(b'my file contents'), "test.jpg"))
        self.assertEqual(response.status_code,400)
    ...
    def party_edit_mising_fields(self):
